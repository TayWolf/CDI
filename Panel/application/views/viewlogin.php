...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Admin<b>CDI</b></a>
            <small>Sistema de Administración</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="http://localhost/CDI/Panel/">
                    <div class="msg">Ingrese su correo y contraseña para iniciar sesión</div>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">person</i>
                        </span>
                        <div class="form-line">
                            <input type="text" class="form-control" id="correo"  name="correo" placeholder="Username" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
    ...
    <script src="content/js/pages/examples/sign-in.js"></script>
</body>
