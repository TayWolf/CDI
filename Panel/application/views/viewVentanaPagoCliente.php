                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h2 style="margin-top: 10px;color:#fff;">
                                    Pago de la factura del sistema
                                </h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-sm-6" align="center">
                                                    <label for="cantidadAdeudada">Cantidad adeudada</label>
                                                    <input class="form-control" type="text" step="0.01" id="cantidadAdeudada" name="cantidadAdeudada" value="<?=$datosGenerales['deuda']?>" readonly>
                                            </div>
                                            <div class="col-sm-6" align="center">
                                                <label for="cantidadPagar">Cantidad a pagar</label>
                                                <input class="form-control" type="number" step="0.01" id="cantidadPagar" name="cantidadPagar" value="" min="0.01" max="<?=$datosGenerales['deuda']?>"  placeholder="Inserte la cantidad a pagar" required>
                                            </div>
                                    ...
                                    <div class="modal-footer" style="text-align: center;">
                                        ...
                                        <button type="button" id="btnPago" class="btn btn-default" onclick="pagar()">Pagar y cerrar</button>
...
<script>
    function pagar()
    {
        ...
        $.ajax({
            url: 'http://localhost/CDI/Panel/index.php/CrudFacturas/ejecutarPagoCliente/<?=$idFactura?>/',
            data: {montoPagado: $("#cantidadPagar").val()},
            type: 'post',
            dataType: 'json',
