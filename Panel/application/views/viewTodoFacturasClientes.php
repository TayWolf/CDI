     ...
     $(window).load(function ()
    {
        $('#pacienteName').autocomplete({
            ...
            select:function(event,ui) {
                ...
                $("#pacienteName").val(ui.item.nombreCliente);
               getlistado();
            }
        });
    });
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-md-4" style="margin-bottom: 0px;">
                                ...
                                <div class="input-group input-group-lg" style="margin-bottom: 0px;">
                                    <div class="">
                                        <input type="text" id="pacienteName" onkeyup="myFunction();" name="pacienteName"  class="form-control backInputs" placeholder="Busqueda por cliente">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-md-offset-2" style="margin-bottom: 0px;">
                                <p>
                                    <b>Adeudo mayor ó igual a</b>
                                </p>
                                <div class="input-group input-group-lg" style="margin-bottom: 0px;">
                                    <div class="">
                                        <input type="text" id="adeudoMinimo" onkeyup="myFunction();" name="adeudoMinimo" onchange="getlistado();" class="form-control backInputs" placeholder="Adeudo mínimo">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 " style="margin-bottom: 0px;">
                                <p>
                                    <b>Adeudo menor ó igual a</b>
                                </p>
                                <div class="input-group input-group-lg" style="margin-bottom: 0px;">
                                    <div class="">
                                        <input type="text" id="adeudoMaximo" onkeyup="myFunction();" name="adeudoMaximo" onchange="getlistado();" class="form-control backInputs" placeholder="Adeudo máximo">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div style="width: 100%; max-height: 390px; overflow-y: scroll;">
...
<script src="http://localhost/CDI/Panel/content/js/funcionesFacturasistemacliente.js"></script>
...
<script type="text/javascript">
 ...
 {
     var e = new Date().getTime() + (milisegundos * 1000);
     while (new Date().getTime() <= e) {}
 }
 window.onload=Concurrent.Thread.create(monitorearEstado);
