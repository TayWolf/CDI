                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group" style="margin-bottom: 0px;">
                                                    ...
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" id="ClientFa" class="form-control" placeholder="Nombre cliente" value="<?=$datosGenerales['nombrePaci']?>" disabled>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group" style="margin-bottom: 0px;">
                                                    ...
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" id="rfcC" class="form-control" placeholder="RFC cliente" value="<?=$datosGenerales['rfc']?>" disabled>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group" style="margin-bottom: 0px;">
                                                    ...
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" id="DirecC" class="form-control" placeholder="Domicilio cliente" value="<?=$datosGenerales['domicilio']." Colonia ".$datosGenerales['colonia'].", ".$datosGenerales['delegacion'].", ".$datosGenerales['estado']?>" disabled>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 0px;">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input type="number" id="serMedi" class="form-control" disabled>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 0px;">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input type="number" id="ivit" class="form-control" disabled>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 0px;">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input type="number" id="total" class="form-control" value="<?=$datosGenerales['montoPago']?>" disabled>
