                        ...
                        <div class="card">
                            <div class="header" style="background-color: #293a4a;">
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                  <a href="http://localhost/CDI/Panel/index.php/Crudcompras/Folio"><h2 class="Salto" style="margin-top: 10px;color:#fff;">
                                    Cuento con Num. de orden
                                  </h2></a>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="NombreArt" name="NombreArt" oninput="articulos()" class="form-control">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="UnidadArt" name="UnidadArt" class="form-control">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="number" onchange="calImporte();" id="DescuentoArt" name="DescuentoArt" class="form-control">
