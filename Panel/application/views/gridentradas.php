                                  ...
                                  <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="noEnt" name="noEnt" class="form-control"  readonly>
                                                <input type="hidden" id="noEntrada" name="noEntrada">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="NombreArt" onkeyup="myFunction();" name="NombreArt" class="form-control" oninput="articulo();">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="UnidadArt" onkeyup="myFunction();" name="UnidadArt" class="form-control">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="importeArt" onkeyup="myFunction();" name="importeArt" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="tablaAgregar" style="display: none;">
                                ...
                                <div class="row clearfix">
                                   <div class="col-md-offset-5">
                                      <div class="button-demo">
                                        <input type="submit" onclick="SaveEntrada();" class="btn bg-black waves-effect waves-light" value="Aceptar">
                                      </div>
                                    </div>
                                </div>
                            </div>    
...
function myFunction() {
 ...
 <!-- <script src="http://localhost/CDI/Panel/content/plugins/bootstrap-select/js/bootstrap-select.js"></script>  -->
  <script src="http://localhost/CDI/Panel/content/js/funcionesEntrada.js"></script>
