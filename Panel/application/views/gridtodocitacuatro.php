      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="table-responsive">
                <table class="table table-bordered estiloPer" style="width: 1283px;">
                        ...
                        <div class="card">
                           ...
                           <div class="content" style="border-bottom: 1px solid #ccc">
                              <div class="center" align="center" style="margin-bottom: 20px;">
                                    <h3 style="margin: 0px;">Datos de la citas</h3>
                              </div>
                            <div class="row clearfix">
                              <div class="col-md-2" id="divfecha">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <div class="form-line">
                                            <input form="form" type="date" id="fecha" name="fecha" class="form-control degrado" style="border-radius: 8px;"  required onchange="diaSemana(1);limpiamodal(); traedisponibilidad(); traecitaPropuesta(); traerCitas()">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group input-group-lg">
                                      <div class="form-line">
                                        <select form="form" id="Salas" name="Salas" class="form-control show-tick degrado" data-live-search="true" required onchange="traeMedico();limpiainputshora();limpiamodal(); traedisponibilidad(); traecitaPropuesta(); traerCitas();traerDiPaciente()" style="border-radius: 8px;"> 
                            ...
                            <div class="row" id="horasSeleccionadas">
                                  ...
                                  <div id="datosPacien" style="display:block;">
                                                   <div class="col-md-4">
                                                        ...
                                                        <div class="input-group input-group-lg">
                                                            <span class="input-group-addon" style="cursor:pointer;"><a id="editModal" onclick="visualModalEdit()" style="display: block;">Editar</a>
                                  ...
                                  <div class="col-md-8 col-md-offset-2" align="center" style="margin-top: 10px;margin-bottom: 0px;">
                                    ...
                                    <div class="col-md-12">
                                          ...
                                          <div class="col-md-4" style="padding-left: 0px;padding-right: 0px;width: 455px;">
                                                <div class="col-md-6" id="visualIndica" style="padding-left: 0px;display: block;padding-right: 01px;">
                                                    <div class="modal-content">
                                                ...
                                                <div class="col-md-6" id="visualObservaciones" style="padding-left: 0px;display: block;padding-right: 0px;">
                                                  <div class="modal-content">
                                                     <div class="modal-header" style="padding-top: 0px; padding-bottom: 0px;">
                                                        <b>Observaciones del paciente</b>
                                                      </div>
                                                      <div>
                                                          <textarea form="form" id="observacionesPaciente" name="observacionesPaciente" onkeyup="form.observacionesPaciente.value=form.observacionesPaciente.value.toUpperCase();"  class="form-control" style="height: 150px;"></textarea>
                                                    </div>
                                                  </div>
                                                </div>   
                                            </div>
                                    ...
                                    <div class="col-md-12" align="center">
                                      ...
                                      <input form="form"  type="submit" class="btn bg-black waves-effect waves-light" value="Agregar" onclick="establecerCitasSinGuardar(true)">
                                    </div>
                                    ...
                                    <div class="row" >
                                      ...
                                      <div class="row clearfix">
                                           <div id="autorizaBoton" style="display: block;" align="center">
                                              <div class="button-demo">
                                                <!-- <button class="btn bg-black waves-effect waves-light" onclick="finalizarCita()">Crear Cita</button> -->
                                                 <button class="btn bg-black waves-effect waves-light" onclick="establecerCitasSinGuardar(false); finalizarCita();">Guardar Cambios</button>
                                              </div>
                                            </div>
                                        </div>
...
function corteVisual()
 ...
 <!--  <script src="http://localhost/CDI/Panel/content/js/funcionesmodalC.js"></script> -->
  ...
  function getDaCita()
  {
    ...
    $.ajax({
        url : "<?php echo site_url('Crudcitas/obtenerInfoGraCitasHour/')?>" + idCiMod,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          ...
          $("#paciente").val(data.nombrePaci);
           ...
           $("#indicacionPaciente").append(data.indicacionesPaciente);
           $("#observacionesPaciente").append(data.observacionesPaciente);
          ...
          otro(data.idMedico,data.factura)
