...
class CrudImportarusuario extends CI_Controller
{
  ...
  {
    $this->load->view("gridimportausuarios");
  }
  ...
  public function to_mysql()
  {
    ...
    if(!is_dir("./excel_import/")) 
      mkdir("./excel_import/", 0777);
 
    //comprobamos si el archivo ha subido para poder utilizarlo
    if ($file && copy($_FILES['excel']['tmp_name'],"./excel_import/".$file))
    {
      ...
      $archivoexl = "/home/cointic/public_html/CDI/Panel/excel_import/".$file;
      // echo "el archivo es $archivoexl";
      
      $objReader = new PHPExcel_Reader_Excel2007();
      $objPHPExcel = $objReader->load($archivoexl);
      ...
      */
      ...
      $import_excel = $this->user->excel($table_name,$sql);
